...
const CATALOG = [
  ...
  { code: "BD-12", name: "Red Velocity", c1: "#121A2A", c2: "#2C3A55", extra: true },
  { code: "BD-13", name: "Neon Blitz", c1: "#E91E8C", c2: "#6B2AE0", extra: true },
  { code: "BD-14", name: "Green Vortex", c1: "#0B4FA8", c2: "#0FB9C9", extra: true },
    ...
    <div className="jbm">
      ...
      <section id="harga" style={{ position: "relative", padding: "80px 0", overflow: "hidden" }}>
        ...
        <div style={{ position: "relative", maxWidth: 1024, margin: "0 auto", padding: "0 20px", textAlign: "center" }}>
          ...
          {/* price display */}
          <div className="reveal price-mobile-center" style={{ marginTop: 48, textAlign: "left", display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: 40, alignItems: "start", maxWidth: 640, margin: "48px auto 0" }}>
            <div>
            ...
            <ul className="price-list" style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: 16, fontSize: 15, color: "#D9DEE7" }}>
              ...
              {["Full printing, pilih dari katalog desain", "Nama dan nomor punggung", "Revisi desain tanpa batas", "Bahan dry-fit standar liga pro, nyaman dan tidak bau", "Printing sublime, warna cerah dan tahan bertahun-tahun"].map((item) => (
          ...
          {priceMode === "ecer" && (
            <p className="reveal eyebrow" style={{ fontSize: 10, color: "rgba(217,222,231,.55)", marginTop: 32, textAlign: "center", maxWidth: 640, margin: "32px auto 0" }}>
