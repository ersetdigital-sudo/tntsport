...
export interface CategoryLandingConfig {
  ...
  wa: {
    ...
    closing: string;
    atasan: string;
    /** template WA Atasan mode Ecer (override per kategori; fallback ke `atasan` jika kosong) */
    atasanEcer?: string;
    /** template WA Atasan mode Lusin (override per kategori; fallback ke `atasan` jika kosong) */
    atasanLusin?: string;
    setelan: string;
  ...
  football: {
    ...
    pricing: {
      ...
      atasan: {
        ...
        points: [
          "Logo Tim Gratis",
          "1 Sponsor Depan Gratis",
          "Nameset Nama & Nomor",
          "Logo Apparel TNT Wajib",
          "Logo TNT Wajib di Belakang, Bawah Nomor",
