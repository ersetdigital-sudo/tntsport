    ...
    <div className="flex flex-col items-center gap-xl w-full">
      ...
      <div className="flex flex-col items-center gap-md mb-md">
        ...
        <div className="text-center">
          <h1 className="text-2xl font-bold text-white">Masuk ke TNT SPORT</h1>
      ...
      <div className="flex flex-col gap-sm w-full">
        <button
          type="button"
          className="flex items-center justify-center gap-sm w-full py-3.5 px-lg rounded-2xl bg-white/10 backdrop-blur-sm border border-white/20 text-white text-sm font-medium hover:bg-white/20 transition-colors"
        >
      ...
      <div className="flex items-center gap-md w-full">
        ...
        <span className="text-xs text-white/50 font-medium">atau</span>
        <div className="flex-1 h-px bg-white/20" />
      </div>
      ...
      {!showEmailForm ? (
        <button
          ...
          className="w-full py-3.5 px-lg rounded-full bg-white text-green-700 text-sm font-bold hover:bg-white/90 transition-colors shadow-lg"
        >
