 ...
 * centered-left layout with logo, big "TNT SPORT" wordmark with green
  ...
  return (
    <section className="relative overflow-hidden bg-white dark:bg-surface-card">
      ...
      <div className="relative z-10 px-5 pb-5 pt-7 sm:px-8 sm:pt-10">
        ...
        <p className="mt-5 max-w-md text-balance text-base font-extrabold leading-snug text-ink sm:text-xl">
          {taglineLines[0]}
        </p>
        {taglineLines[1] ? (
          <p className="mt-1.5 max-w-md text-pretty text-sm leading-relaxed text-charcoal sm:text-base">
            {taglineLines[1]}
          </p>
        ) : null}
      </div>
