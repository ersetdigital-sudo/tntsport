...
export function CorporateCollectionLanding({ products, waNumber }: Props) {
  ...
  /* ── bigword scroll highlight (mobile only) ── */
  useEffect(() => {
        ...
        <div className="mx-auto max-w-[1400px] px-6 lg:px-12">
          ...
          <div className="mt-16 lg:mt-24 grid lg:grid-cols-2 gap-4 lg:gap-px lg:bg-white/12 lg:border lg:border-white/12">
            ...
            <div className="reveal relative bg-[#1E2023] lg:bg-[#17191C] p-6 lg:p-12 flex flex-col rounded-xl lg:rounded-none border border-white/8 lg:border-0">
              ...
              {t.noteSetelan && <p className="mt-4 text-[12px] lg:text-[13px] text-[#A6A8AA]">{t.noteSetelan}</p>}
              <div className="h-px bg-white/12 my-8" />
              <ul className="space-y-3 text-[14px] lg:text-[15px] text-[#F3F0E8]/85">
                {t.bulletsSetelan.map((b: string, i: number) => (
                  <li key={i} className="flex gap-3"><span className="orange">—</span><span>{b}</span></li>
                ))}
              </ul>
      ...
      <section className="bg-[#17191C] py-24 lg:py-36">
        <div className="mx-auto max-w-[1400px] px-6 lg:px-12">
          ...
          <div className="mt-14 lg:mt-20 grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
            ...
            <div className="reveal ph border border-white/12 aspect-[3/4] lg:mt-10 flex items-end p-5 relative overflow-hidden">
              <img src="https://res.cloudinary.com/dqjh7utdb/image/upload/v1787565275/a8ef753fl8pbgfgbvrfp.png" alt="Team Gathering" className="absolute inset-0 w-full h-full object-cover" />
              <span className="label text-[#A6A8AA] relative z-10">Team Gathering</span>
            </div>
            <div className="reveal ph border border-white/12 aspect-[3/4] flex items-end p-5 relative overflow-hidden">
              <img src="https://res.cloudinary.com/dqjh7utdb/image/upload/v1787565564/pw7x2y2bx0zheoogzw6e.png" alt="Sports Day" className="absolute inset-0 w-full h-full object-cover" />
              <span className="label text-[#A6A8AA] relative z-10">Sports Day</span>
            </div>
            <div className="reveal ph border border-white/12 aspect-[3/4] lg:mt-10 flex items-end p-5 relative overflow-hidden">
              <img src="https://res.cloudinary.com/dqjh7utdb/image/upload/v1787565402/hnvoihx8o2oapdhc7pyk.png" alt="Company Community" className="absolute inset-0 w-full h-full object-cover" />
              <span className="label text-[#A6A8AA] relative z-10">Company Community</span>
            </div>
          </div>
        </div>
      </section>
